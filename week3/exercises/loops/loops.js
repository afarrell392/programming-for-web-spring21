// for loop with number. Variable, brake, increment.
/*
for (let i = 0; i < 10; i++) {
...
const myMovies = ['star wars', 'empire strikes back', 'return of the jedi', 'raiders of the lost arc', 'last crusade'];

for (let j = 0; j < myMovies.length; j++) {
  console.log('i like', myMovies[j]);
}

// whileloop -- use with caution!
let myVar = false;
while (myVar === false) {
